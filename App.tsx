  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex flex-col font-sans">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 w-14 h-14 rounded-full shadow-lg shadow-blue-200/60 ring-2 ring-blue-100 overflow-hidden transition transform hover:scale-105"
      >
        <img
